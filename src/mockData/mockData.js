export const nowPlayingResultsArray = {
  results: [
    {
      vote_count: 507,
      id: 345940,
...
export const mockNowPlayingFetch = {
  results: [
    {
      vote_count: 609,
      id: 345940,
  ...
  page: 1,
  total_results: 954,
  dates: { maximum: '2018-09-05', minimum: '2018-07-19' },
  total_pages: 48
};

export const mockVideoDetailsFetch = {
  id: 353081,
  results: [
    {
...
export const mockMovies = {
  nowPlaying: [
    ...
    },
    {
      ...
      vote_average: 4.8,
      poster_path:
        'http://image.tmdb.org/t/p/original/qjxtWgMzZbkViDqmbjXuuZCj1az.jpg',
      favorite: false
    },
    {
      movie_id: 400155,
